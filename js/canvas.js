...
function getCanvas(id) {
    ...
    console.log(Math.atan2(this.endPoints.y, this.endPoints.x) / (Math.PI/180))
    this.ctx.moveTo(this.beginPoints.x, this.beginPoints.y);
    this.ctx.lineTo(this.endPoints.x, this.endPoints.y);
    this.ctx.stroke()
}
